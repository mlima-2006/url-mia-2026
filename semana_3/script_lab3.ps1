...
"Nombre del estudiante: $nombre" | Out-File "Datos\$nombre.txt" "Fecha de creación: $fecha" | Add-Content "Datos\$nombre.txt" "Laboratorio 3 - Creación de Scripts en PowerShell y Bash" | Add-Content "Datos\$nombre.txt"
...
# Mostrar todos los archivos creados
 Write-Host "`n=== Archivos creados ===" Get-ChildItem -Recurse

# Mostrar el contenido del archivo
Write-Host "`n=== Contenido del archivo ===" Get-Content "Datos\$nombre.txt"